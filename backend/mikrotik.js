...
export async function createHotspotUser({
  ...
  return new Promise((resolve, reject) => {
    const conn = new Client();
    const host = process.env.MIKROTIK_HOST; // desktop-lhohb9l.tailb2222a.ts.net
    const port = 10000; // Match your Funnel port
    ...
    conn
      ...
      .connect({
        ...
        username: process.env.MIKROTIK_USER,
        password: process.env.MIKROTIK_PASS,
        readyTimeout: 40000, // Increased timeout for Tailscale latency
      });
  });
}
